...
* **Età minima richiesta:** 14 anni.
    * *Fino a 16 anni è utilizzabile solo in Italia salvo che Stati UE o SEE ne riconoscano espressamente la validità.*
    * Il conducente che ha compiuto 16 anni può trasportare un eventuale passeggero.
...
> **Nota:** Qualsiasi altra categoria di patente è valida per condurre veicoli della categoria AM.
...
* **Età minima richiesta:** 16 anni.
    * È consentito il trasporto di un eventuale passeggero.
...
* Macchine agricole o loro complessi che non superino i limiti di sagoma e di massa stabiliti dall'art. 53, comma 4, CDS, ovvero:
    * larghezza: 1,60 m
    * lunghezza: 4 m
    * altezza: 2,50 m
...
**Abilita a condurre:**
* Motocicli senza carrozzetta (cat. L3e) o con carrozzetta (cat. L4e), aventi potenza non superiore a 35 kW, rapporto potenza/peso non superiore a 0,2 kW/kg.
* *Abilita a condurre anche veicoli delle categorie AM, A1.*

> **Nota:** Può essere conseguita dal titolare di categoria A1 da almeno due anni, senza sostenere esame di guida, a seguito di frequenza di apposito corso di formazione.
...
> **Nota:** Può essere conseguita dal titolare di categoria A2 da almeno due anni, senza sostenere esame di guida, a seguito di frequenza, presso un'autoscuola, di apposito corso di formazione.
...
* Autoveicoli senza rimorchio adibiti al trasporto di merci, alimentati con combustibili alternativi, con massa superiore a 3500 kg ma non superiore a 4250 kg (dovuta all'eccesso di massa del sistema di propulsione), a condizione che la patente sia conseguita da almeno due anni.
...
* Autotreni costituiti da motrice max 3.500 kg e rimorchio > 750 kg, purché la massa massima del complesso non superi 4.250 kg.
    * *Se il complesso supera 3.500 kg, è richiesta la patente B con codice UE armonizzato "96".*
...
* Trenini turistici con numero di passeggeri trasportabili uguale o inferiore a 8.
...
**Abilita a condurre:**
* Autoveicoli (diversi da D1 e D) aventi massa > 3.500 kg ma non superiore a 7.500 kg, destinati al trasporto di non più di 8 persone oltre al conducente.
...
**Abilita a condurre:**
* Complessi: motrice C + rimorchio > 750 kg.

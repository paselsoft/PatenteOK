      ...
      >
        ...
        <div className="p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 rounded-br-3xl flex flex-col gap-4">
          <ResetConfirmationButton
            variant="full"
            label="Reset Dati App"
            className="text-red-600 bg-red-50 hover:bg-red-100 dark:bg-red-900/20 dark:hover:bg-red-900/30 dark:text-red-400 font-bold justify-center"
          />

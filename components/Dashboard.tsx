    ...
    return (
        <PageTransition className="flex-1 max-w-2xl mx-auto w-full px-4 py-8 flex flex-col gap-10 pb-32">
            ...
            <section className="flex flex-col gap-4">
                <h3 className="text-lg font-black text-slate-800 dark:text-slate-100 px-1 tracking-tight">Configurazione Pratica</h3>
                <ProfileSection />
            </section>

            {/* CHECKLIST DOCUMENTI */}
            <section className="flex flex-col gap-4">
                <h3 className="text-lg font-black text-slate-800 dark:text-slate-100 px-1 tracking-tight">Checklist Documenti</h3>
                <DocumentList />
            </section>
